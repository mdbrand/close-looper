              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {allDrafts.map(draft => {
                    ...
                    return (
                      <tr key={draft.id} className="border-b border-border hover:bg-muted/30 transition-colors cursor-pointer" onClick={() => { setIsEditing(false); setSelectedDraft(draft); }}>
                        ...
                        <td className="px-4 py-3 max-w-[200px] truncate">{draft.subject}</td>
