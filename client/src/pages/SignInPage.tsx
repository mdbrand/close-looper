  ...
  return (
    <div className="min-h-screen bg-[#FAFAF7] flex items-center justify-center px-4">
      <div className="max-w-sm w-full">
        <div className="text-center mb-8">
          <Link href="/"><span className="text-2xl font-serif font-bold">Close Looper</span></Link>
          <h1 className="text-2xl font-serif font-bold mt-4 mb-2">Welcome back</h1>
          <p className="text-muted-foreground text-sm">Sign in to your Close Looper account.</p>
        </div>
        <div className="bg-white border border-border/40 rounded-2xl p-8 shadow-sm space-y-4">
          <Button
            className="w-full bg-[#1a1a1a] text-white hover:bg-[#333] gap-2"
            onClick={() => startLogin()}
          >
